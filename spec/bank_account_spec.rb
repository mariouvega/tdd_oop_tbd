...
describe BankAccount do
	...
	context " minimum balance" do
		...
		it "does NOT raise an error if opening balance is over minimum balance" do
			expect { BankAccount.new(201, "Terrry") }.not_to raise_error
		end

		it "allows the bank owner too change the minimum balance" do
			expect(BankAccount.minimum_balance=(100)).to eq(100)
		end
